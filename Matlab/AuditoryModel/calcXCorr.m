...
%             'coeff'    - scales XCORR by the autocorrelation at lag zero
%             'none'     - no scaling
%             (default, scale = 'none')
%
%OUTPUT ARGUMENTS
...
%   History :   
%   v.0.1   2008/01/12
%   v.0.2   2008/05/11 added various GCC weighting functions
%   v.0.3   2008/05/21 added detrend weight
%   v.0.4   2008/07/27 added spectral smoothing
%   v.0.5   2008/12/11 added biased und unbiased normalization
%   v.0.6   2009/03/10 added ML weighting
%   ***********************************************************************
...
if maxLags >= M,
    % Pad with zeros
    padZeros = zeros(maxLags-M+1,N^2);
