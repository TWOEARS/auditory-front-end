function varargout = calcAvgDevMEX(varargin)
%calcAvgDev   Private method, which is normally shadowed by the
%corresponding MEX routine. It will ONLY be executed, if the underlying MEX
