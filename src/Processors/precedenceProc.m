...
% above and in the constructor. A quick search and replace for "precedenceProc" should allow
% not to miss any!
%
...
%% Methods
    methods
        ...
        %precedenceProc   Construct a processor
        %
        % USAGE:
        ...
        % See also: genParStruct, parameterHelper, Processor
            ...
            if nargin>0 && ~isempty(fs)
                ...
                b1=-0.0938272;          % Frequency weighting according to Stern et al. (1988)
                b2=0.000112586;         % frequency weighting filter coefficients: b1, b2, b3
                b3=-0.0000000399154;
            end
        end
...
%         end
    ...
    methods (Static)
        ...
        function pInfo = getProcessorInfo
            ...
            pInfo.label = 'Precedence effect model';
            pInfo.requestName = 'precedence';
            pInfo.requestLabel = 'Precedence effect model output';
