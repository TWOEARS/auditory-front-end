function out = calcSpecCentroid(spec,fHz)
%calcSpecCentroid   Compute the spectral center of gravity in Hertz.
%   
%USAGE
%      out = calcSpecCentroid(spec,fHz)
%
%INPUT ARGUMENTS
...
% 
%OUTPUT ARGUMENTS
%      out : spectral centroid in Hertz [nFrames x 1]
%
%REFERENCES
...
% Spectral centroid : Center of mass/gravity of the spectrum
out = sum(repmat(fHz,[nFrames 1]) .* spec, 2)./(sum(spec,2) + epsilon);
