...
switch request
    ...
    case 'gabor'
        ...
        if p_full.rm_wSizeSec ~= 25E-3
            p_full.rm_wSizeSec = 25E-3;
            warning('Gabor feature extraction is based on a given window size for ratemaps. Fixing the window size to 25ms.')
        end
        
        if p_full.rm_wStepSec ~= 10E-3
            p_full.rm_wStepSec = 10E-3;
